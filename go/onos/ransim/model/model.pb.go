...
type SendPacketsRequest struct {
	NCGI     github_com_onosproject_onos_api_go_onos_ransim_types.NCGI  `protobuf:"varint,1,opt,name=ecgi,proto3,casttype=github.com/onosproject/onos-api/go/onos/ransim/types.NCGI" json:"ecgi,omitempty"`
	CRNTI    github_com_onosproject_onos_api_go_onos_ransim_types.CRNTI `protobuf:"varint,2,opt,name=crnti,proto3,casttype=github.com/onosproject/onos-api/go/onos/ransim/types.CRNTI" json:"crnti,omitempty"`
	Downlink bool                                                       `protobuf:"varint,3,opt,name=downlink,proto3" json:"downlink,omitempty"`
	Payloads []uint32                                                   `protobuf:"varint,4,rep,packed,name=payloads,proto3" json:"payloads,omitempty"`
}

func (m *SendPacketsRequest) Reset()         { *m = SendPacketsRequest{} }
func (m *SendPacketsRequest) String() string { return proto.CompactTextString(m) }
...
func (m *SendPacketsRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *SendPacketsRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_SendPacketsRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *SendPacketsRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SendPacketsRequest.Merge(m, src)
}
func (m *SendPacketsRequest) XXX_Size() int {
	return m.Size()
}
func (m *SendPacketsRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_SendPacketsRequest.DiscardUnknown(m)
}

var xxx_messageInfo_SendPacketsRequest proto.InternalMessageInfo

func (m *SendPacketsRequest) GetNCGI() github_com_onosproject_onos_api_go_onos_ransim_types.NCGI {
	if m != nil {
		return m.NCGI
	}
	return 0
...
func (m *SendPacketsRequest) GetCRNTI() github_com_onosproject_onos_api_go_onos_ransim_types.CRNTI {
	if m != nil {
		return m.CRNTI
	}
	return 0
...
func (m *SendPacketsRequest) GetDownlink() bool {
	if m != nil {
		return m.Downlink
	}
	return false
...
func (m *SendPacketsRequest) GetPayloads() []uint32 {
	if m != nil {
		return m.Payloads
	}
	return nil
...
type SendPacketsResponse struct {
	NCGI   github_com_onosproject_onos_api_go_onos_ransim_types.NCGI  `protobuf:"varint,1,opt,name=ecgi,proto3,casttype=github.com/onosproject/onos-api/go/onos/ransim/types.NCGI" json:"ecgi,omitempty"`
	CRNTI  github_com_onosproject_onos_api_go_onos_ransim_types.CRNTI `protobuf:"varint,2,opt,name=crnti,proto3,casttype=github.com/onosproject/onos-api/go/onos/ransim/types.CRNTI" json:"crnti,omitempty"`
	Status []bool                                                     `protobuf:"varint,3,rep,packed,name=status,proto3" json:"status,omitempty"`
}

func (m *SendPacketsResponse) Reset()         { *m = SendPacketsResponse{} }
func (m *SendPacketsResponse) String() string { return proto.CompactTextString(m) }
...
func (m *SendPacketsResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *SendPacketsResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_SendPacketsResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *SendPacketsResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SendPacketsResponse.Merge(m, src)
}
func (m *SendPacketsResponse) XXX_Size() int {
	return m.Size()
}
func (m *SendPacketsResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_SendPacketsResponse.DiscardUnknown(m)
}

var xxx_messageInfo_SendPacketsResponse proto.InternalMessageInfo

func (m *SendPacketsResponse) GetNCGI() github_com_onosproject_onos_api_go_onos_ransim_types.NCGI {
	if m != nil {
		return m.NCGI
	}
	return 0
...
func (m *SendPacketsResponse) GetCRNTI() github_com_onosproject_onos_api_go_onos_ransim_types.CRNTI {
	if m != nil {
		return m.CRNTI
	}
	return 0
...
func (m *SendPacketsResponse) GetStatus() []bool {
	if m != nil {
		return m.Status
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*SendPacketsRequest)(nil), "onos.ransim.model.SendPacketsRequest")
	proto.RegisterType((*SendPacketsResponse)(nil), "onos.ransim.model.SendPacketsResponse")
...
var fileDescriptor_9942ba2f94296ec8 = []byte{
	...
	,
}
...
type CellModelClient interface {
	...
	SendPackets(ctx context.Context, in *SendPacketsRequest, opts ...grpc.CallOption) (*SendPacketsResponse, error)
}
...
func (c *cellModelClient) SendPackets(ctx context.Context, in *SendPacketsRequest, opts ...grpc.CallOption) (*SendPacketsResponse, error) {
	out := new(SendPacketsResponse)
	err := c.cc.Invoke(ctx, "/onos.ransim.model.CellModel/SendPackets", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CellModelServer interface {
	...
	SendPackets(context.Context, *SendPacketsRequest) (*SendPacketsResponse, error)
}
...
func (*UnimplementedCellModelServer) SendPackets(ctx context.Context, req *SendPacketsRequest) (*SendPacketsResponse, error) {
...
func _CellModel_SendPackets_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SendPacketsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CellModelServer).SendPackets(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/onos.ransim.model.CellModel/SendPackets",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CellModelServer).SendPackets(ctx, req.(*SendPacketsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _CellModel_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _CellModel_SendPackets_Handler,
		},
	},
	Streams: []grpc.StreamDesc{
		{
...
func (m *SendPacketsRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *SendPacketsRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *SendPacketsRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.Payloads) > 0 {
		dAtA13 := make([]byte, len(m.Payloads)*10)
		var j12 int
		for _, num := range m.Payloads {
			for num >= 1<<7 {
	...
	if m.CRNTI != 0 {
		i = encodeVarintModel(dAtA, i, uint64(m.CRNTI))
		i--
		dAtA[i] = 0x10
	}
	if m.NCGI != 0 {
...
func (m *SendPacketsResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *SendPacketsResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *SendPacketsResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *SendPacketsRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *SendPacketsResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if len(m.Status) > 0 {
		n += 1 + sovModel(uint64(len(m.Status))) + len(m.Status)*1
	}
	return n
}
...
func (m *SendPacketsRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SendPacketsRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SendPacketsRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.CRNTI |= github_com_onosproject_onos_api_go_onos_ransim_types.CRNTI(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 4:
			if wireType == 0 {
				...
				elementCount = count
				if elementCount != 0 && len(m.Payloads) == 0 {
					m.Payloads = make([]uint32, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v uint32
					for shift := uint(0); ; shift += 7 {
...
func (m *SendPacketsResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SendPacketsResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SendPacketsResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
