...
// E2Taddress is onos-ric SCTP address
type E2Taddress string
...
const (
	...
	// HeightKey - used in topo device attributes
	HeightKey = "height"

	// FrequencyKey - used in topo device attributes
	FrequencyKey = "frequency"

	// DefaultPowerKey - used in topo device attributes
	DefaultPowerKey = "defaultpower"

	// ThetaDegreeKey - used in topo device attributes
	ThetaDegreeKey = "thetadegree"
