...
import (
	"fmt"
	"gitlab.devtools.intel.com/ngs-syseng/onosproject/onos-config/api/types"
	topodevice "gitlab.devtools.intel.com/ngs-syseng/onosproject/onos-topo/api/device"
	"strings"
)
